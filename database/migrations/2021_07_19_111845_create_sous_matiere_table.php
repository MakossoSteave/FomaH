...
class CreateSousMatiereTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('sous_matieres')->insert( ['designation_sous_matiere'=>'Anglais professionnele','matiere_id'=> 6], );
        DB::table('sous_matieres')->insert( ['designation_sous_matiere'=>'Espagnol littéraire','matiere_id'=> 7], );
        DB::table('sous_matieres')->insert( ['designation_sous_matiere'=>'Espagnol professionnele','matiere_id'=> 7], );
    }

...
function addQuestion(){
    ...
    var buttonDeleteQuestion = document.createElement('a');
    buttonDeleteQuestion.id = counter;
    buttonDeleteQuestion.className = 'deleteQuestion';
    buttonDeleteQuestion.innerText = 'Supprimer la question';

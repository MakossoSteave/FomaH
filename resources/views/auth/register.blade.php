            ...
            <div class="mt-5">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div>
                        ...
                        <input name="name"
                            class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500 @error('name') is-invalid @enderror"
                    ...
                    <div class="mt-5">
                        ...
                        <input name="email"
                            ...
                            type="" placeholder="monmail@gmail.com">
                        @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="mt-5">
                        ...
                        <input id="password" type="password"
                            ...
                            placeholder="Entrez votre mots de passe " name="password" required
                    ...
                    <div class="mt-5">
                        ...
                        <input id="password-confirm" type="password"
                            ...
                            placeholder="Confirmez votre mots de passe" name="password_confirmation" required
                            autocomplete="new-password">

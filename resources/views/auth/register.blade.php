...
<div class="lg:flex">
            <div class="lg:w-1/2 xl:max-w-screen-sm">
                ...
                <div class="mt-0 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-6 xl:px-24 xl:max-w-2xl">
                    ...
                    <div class="mt-5">
                        ...
                        @csrf
                            <div>
                                <div class="text-sm font-bold text-gray-700 tracking-wide">Nom</div>
                                <input  name="name" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500 @error('name') is-invalid @enderror" type="" placeholder="Perfect">
                                @error('name')
                            ...
                            <div class="mt-5">
                                ...
                                <input  name="email" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500 @error('email') is-invalid @enderror" type="" placeholder="monmail@gmail.com">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="mt-5">
                                ...
                                <input id="password" type="password" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500 @error('password') is-invalid @enderror" placeholder="Entrez votre mots de passe " name="password" required autocomplete="new-password">
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="mt-5">
                                ...
                                <input id="password-confirm" type="password" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Confirmez votre mots de passe" name="password_confirmation" required autocomplete="new-password">
                        ...
                        <div class="mt-6 text-sm font-display font-semibold text-gray-700 text-center">
                            déja un compte ? <a  href="{{ route('login') }}" class="cursor-pointer text-indigo-600 hover:text-indigo-800">Connection</a>
                        </div>
                    </div>
                </div>
            </div>

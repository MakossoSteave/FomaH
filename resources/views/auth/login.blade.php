        ...
        <div class="mt-0 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
            ...
            <div class="mt-12">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div>
                        ...
                        <input name="email"
                            ...
                            type="" placeholder="millouse95100@gmail.com">
                        @error('email')
                    ...
                    <div class="mt-8">
                        ...
                        <input name="password"
                            ...
                            type="password" placeholder="Entrez votre mots de passe ">
                ...
                <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                    Vous êtes nouveau ? <a href="{{ route('register') }}"
                        class="cursor-pointer text-indigo-600 hover:text-indigo-800">Inscription</a>
                </div>
            </div>
        </div>
    </div>

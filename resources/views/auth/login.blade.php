        ...
        <div class="lg:flex">
            <div class="lg:w-1/2 xl:max-w-screen-sm">
                ...
                <div class="mt-0 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                    ...
                    xl:text-bold">Connection</h2>
                    <div class="mt-12">
                        <form method="POST" action="{{ route('login') }}">
                        @csrf
                            <div>
                                <div class="text-sm font-bold text-gray-700 tracking-wide">Mail</div>
                                <input  name="email" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500 @error('email') is-invalid @enderror" type="" placeholder="millouse95100@gmail.com">
                                @error('email')
                            ...
                            <div class="mt-8">
                                ...
                                <input name="password" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500 @error('password') is-invalid @enderror" type="password" placeholder="Entrez votre mots de passe ">
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                            Vous êtes nouveau  ? <a  href="{{ route('register') }}" class="cursor-pointer text-indigo-600 hover:text-indigo-800">Inscription</a>
                        </div>
                    </div>
                </div>
            </div>

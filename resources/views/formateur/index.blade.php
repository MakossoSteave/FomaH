...
<div class="relative bg-white">
    <div class="max-w-5xl flex items-center h-auto lg:h-1.5 flex-wrap mx-auto my-32 lg:my-0 p-4">
        ...
        <div id="profile"
            ...
            <div class="p-4  text-center lg:text-left">
                ...
                <p class="pt-8 text-sm">Je suis formateur
                </p>
    ...
    <h1 class="text-center p-5  text-indigo-800 font-black text-3xl"> Centre de formation</h1>
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6">
            <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                ...
                <div class="px-5 py-3">
                    <h3 class="text-gray-700 uppercase">Pompidou</h3>
            ...
            <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                ...
                <div class="px-5 py-3">
                    <h3 class="text-gray-700 uppercase">My course</h3>
            ...
            <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                ...
                <div class="px-5 py-3">
                    <h3 class="text-gray-700 uppercase">Centre de la fontaine</h3>

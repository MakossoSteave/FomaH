...
<body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
        ...
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20"
                ...
                <ul class="list-reset lg:flex justify-end flex-1 items-center">
                    <li class="mr-3">
                        <a class="inline-block py-2 px-4 text-black font-bold no-underline" href="#">Acceuil</a>
                    </li>
                    <li class="mr-3">
        ...
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                <h1 class="my-4 text-5xl font-bold leading-tight">
                    Description du centre de formation ...
                </h1>
                ...
                <button
                    ...
                    <a href="{{ url('Ajoutforma')}}"> Ajouté une formation</a>
                </button>
            </div>
            <!--Right Col-->
            <div class="w-full md:w-3/5 py-6 text-center">
                <img class="w-full md:w-4/5 z-50"
                    src="https://assets-global.website-files.com/5ec3fa0db380dec4be60ee2d/5ee7a7de5ae8d347c0c723a8_Superguide_Beginners%20Guide.svg" />
            </div>
        </div>
    </div>
    ...
    <section class="bg-white border-b py-8">
        <div class="container max-w-5xl mx-auto m-8">
            ...
            @if($data->isEmpty())
            <p style="color:rebeccapurple;text-align:center">Vous n'avez pas encore de formation à geré ,veuilliez créer
                vos
                Formations
            </p>
            @else
            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-5/6 sm:w-1/2 p-6">
                    ...
                    <p class="text-gray-600 mb-8">
                        ...
                        Formateur référent: Bill

                    </p>
                    <form class="max-w-md mb-4 form-input" action="{{ route('centre.destroy', $formation->id) }}"
                        method="POST">

                        <a class="bg-indigo-500 text-gray-100 p-4 w-5/10 rounded-full tracking-wide
                        ...
                        @if(Auth::user()->id == $formation->userRef)
                        <a class="bg-yellow-200 text-gray-100 p-4 w-5/10 rounded-full tracking-wide
                                font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-yellow-400
                                shadow-lg" href="{{ route('centre.edit', $formation->id) }}">
                        ...
                        <button type="submit" title="delete" class="bg-red-200 text-gray-100 p-4 w-5/10 rounded-full tracking-wide

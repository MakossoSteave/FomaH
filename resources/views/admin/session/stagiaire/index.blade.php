...
<div class="container">
    ...
    <div class="card my-6 
@if($stagiaire->validation!==null && ($sessionTerminée==true) ) {{ $stagiaire->validation == 1 ? 'has-background-success' : 'has-background-danger'  }} @endif">
@if($stagiaire->etat == 1) 
                 ...
                 <div></div>
                    <div class="dropdown is-right is-hoverable">
                        <div class="dropdown-trigger">
                            <button class="button borderNone is-right  @if($stagiaire->validation!==null && ($sessionTerminée==true) ) {{ $stagiaire->validation == 1 ? 'has-background-success' : 'has-background-danger'  }} @endif"
                                    aria-haspopup="true"
            ...
            <div class="content">
                <div class="flex">
                    <div>
                        ...
                        @if($stagiaire->resultat_description && ($sessionTerminée==true ))
                    ...
                    @if(($sessionTerminée==true) && $stagiaire->etat == 1  && ( $sessionEtat==1) )
                    ...
                    @endif
                    @if( $stagiaire->etat == 1 && $stagiaire->validation==1 && ($sessionTerminée==true)  && ( $sessionEtat==1) )
